...
Page({
  ...
  onLoad(options) {
    ...
    c1.collection('shijing').limit(20).get()
    //请求成功
    .then(res =>{
      //console.log(res)
      this.setData( 
...
onDetail: function (e) {
  ...
  wx.navigateTo({
    url: "/packageA/pages/shijing_re_detail?id=" + imgId   //?id连字符加上imgId
});
},
...
onReachBottom: function () {
  ...
  if(this.data.page>16)
  {
    ...
    this.newsrequest(this.data.page);}
...
c1.collection('shijing').skip(page*20).limit(20).get({
  success(res){
